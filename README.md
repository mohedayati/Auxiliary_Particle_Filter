An Auxiliary Particle Filter (APF) implementation is provided in this repository for state and parameter estimation of non-linear and multi-modal dynamic systems with added Non-Gaussian noise.
